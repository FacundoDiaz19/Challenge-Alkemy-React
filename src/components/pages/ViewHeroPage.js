  ...
  return (
    <div className="">
      ...
      <div className="container my-3">
        <h1 className="fs-1 text-center font-h1 mt-4 mb-2">
          this is your hero
        </h1>
        {Hero
          ? Hero.map((hero) => (
                ...
                <div className="row g-0">
                  ...
                  <div className="col-7 col-sm-8">
                    <div className="card-body">
                      <h3 className="card-title font-h2 fs-2 text-center">
                        {hero.name}
                      </h3>
                      ...
                      <p className="card-text">
                        <strong>First apparition: </strong>{" "}
                        {hero.biography["first-appearance"]}
                      </p>
                      <p className="card-text">
                        <strong>Work Place: </strong> {hero.work.base}{" "}
                      </p>
                      <p className="card-text">
                        <strong>Occupation: </strong> {hero.work.occupation}{" "}
                      </p>
                    </div>
                    <Link to={"/"} className="btn btn-info col-md-4 my-2 mx-4">
                      Return
                    </Link>
                  </div>
                </div>
